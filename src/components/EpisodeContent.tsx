...
import { Episode, episodes } from "@/data";
...
export default function EpisodeContent({ episode }: EpisodeContentProps) {
  ...
  return (
    <div className="min-h-screen -mt-20 pt-20" style={{ backgroundColor: "#2B4593" }}>
        ...
        <article>
          <header className="mb-12">
            ...
            <h1 className="font-serif text-3xl md:text-4xl text-cream mb-4">
              <TypewriterText text={episode.title} />
            </h1>
            <p className="text-cream/70 text-lg">
              <TypewriterText text={episode.subtitle} delay={0.4} />
            </p>
          </header>
          ...
          {episode.recipe && (
            ...
            >
              <h2 className="font-serif text-2xl text-cream mb-8">
                <TypewriterText text={episode.recipe.title} />
              </h2>
